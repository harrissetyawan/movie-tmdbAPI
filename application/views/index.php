...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <form class="form-inline" method="post" action="<?= base_url();?>welcome/search">
    ...
    <div class="container-fluid">
      ...
      <!-- Page Heading -->
      <h1 class="my-4" style="font-size:50px; color:black; text-shadow: 4px 1px 5px rgba(181,210,255,0.83);">Now Playing
        <small>movies</small>
      </h1>
                    <!-- Isi Content -->
      <div class="row"> 
